...
export default function AdminSchedule() {
    ...
    const [checklist, setChecklist] = useState(serverChecklist ?? SAMPLE_CHECKLIST);
    ...
    function tandaiSelesai(id) {
        setChecklist(prev => prev.map(r => r.id === id ? { ...r, status: 'Telah Disalurkan' } : r));
        ...
        <AdminLayout activeMenu="jadwal" user={auth?.user}>
            <div className="px-12 pt-12 pb-16 flex flex-col gap-6">
                ...
                <div className="flex gap-6 items-start">
                    <div
                        className="bg-white rounded-[14px] shadow-sm flex flex-col w-[220px] shrink-0"
