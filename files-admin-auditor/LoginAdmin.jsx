        ...
        >
            <div className="w-full max-w-[448px] flex flex-col items-center gap-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-white font-bold text-xl">Admin Desa</p>
                        <p className="text-white/80 text-sm">Operator Kelurahan</p>
                    </div>
                </div>
                ...
                <div className="bg-white w-full rounded-[14px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] border border-black/10 overflow-hidden">
                    <div className="px-6 pt-6 pb-4 border-b border-black/10">
                        <h1 className="text-[#2c2c2c] font-semibold text-2xl">Masuk</h1>
                        <p className="text-[#717182] text-base mt-1">
                            Masukkan NIK dan password untuk mengakses panel admin desa
                        </p>
                    </div>
                    ...
                    <form onSubmit={submit} className="px-6 py-5 flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-[#717182] text-xs">NIK harus terdiri dari 16 digit angka</p>
                        </div>
                        ...
                        >
                            {processing ? 'Memproses...' : 'Masuk sebagai Admin Desa'}
                        </button>
                    </form>

                    <div className="px-6 pb-6 text-center">
                        <p className="text-[#717182] text-xs">
                            Halaman ini hanya untuk Operator Kelurahan yang berwenang
                        </p>
                    </div>
                </div>

                <a href={route('home')} className="text-white text-sm hover:underline">
                    ← Kembali ke Beranda
                </a>
            </div>
        </div>
